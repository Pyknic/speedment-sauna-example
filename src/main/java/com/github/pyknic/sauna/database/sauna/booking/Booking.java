...
import com.github.pyknic.sauna.database.sauna.booking.generated.GeneratedBooking;

/**
 * An interface representing an entity (for example, a row) in the Table
 * sauna.db0.sauna.booking.
 * <p>
 ...
 * @author pyknic
 */
public interface Booking extends GeneratedBooking {
